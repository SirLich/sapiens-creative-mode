...
--- @shadow
function serverGOMModule:completeImmediatelyCheat(super, buildOrCraftObject, constructableType, planStateOrNil, tribeID)
	local inventory = {
		countByObjectType = {},
		objects = {}
	}
	...
	super(self, buildOrCraftObject, constructableType, planStateOrNil, tribeID)
end


return shadow:shadow(serverGOMModule)